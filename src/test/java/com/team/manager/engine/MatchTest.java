...
class MatchTest {
    ...
    void shouldEqualInteger() {
        ...
        System.out.println(match.lanerComparison(player1, player2));
        assertEquals(2, match.lanerComparison(player1, player2));
    }
    ...
    void shouldReturnString() {
        ...
        assertEquals("Team B won", match.matchSimulation(TeamA,TeamB));
